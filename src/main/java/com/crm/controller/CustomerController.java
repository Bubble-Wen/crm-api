...
public class CustomerController {
    ...
    public void exportCustomer(@RequestBody CustomerQuery query, HttpServletResponse httpResponse) {
        customerService.exportCustomer(query, httpResponse);
    }

    @PostMapping("saveOrUpdate")
    @Operation(summary = "客户列表-保存或更新")
